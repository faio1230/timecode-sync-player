...
// Worker-owned permission from the swapchain latency event. Only an actual Present attempt consumes it.
internal sealed class PresentReadyGate
{
    ...
    {
        // Same decision/event timestamp avoids floor-rounding disagreements near an integer-ms boundary.
