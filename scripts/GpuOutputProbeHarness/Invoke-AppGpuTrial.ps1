...
param(
    ...
    [string]$AppExe = 'C:\Users\codea\Documents\timecode-sync-player-wt-verify-oe-20260911-1344\src\TimecodeSyncPlayer\bin\Debug\net8.0-windows\TimecodeSyncPlayer.exe',
    [string]$LogRoot = 'C:\Users\codea\Documents\timecode-sync-player\.superpowers\worktrees\session-refactor\TestResults\gpu-app-20260911',
    [switch]$NoFullscreen,
...
$receiverExe = 'C:\Users\codea\Downloads\Spout-SDK-examples_2-007-017\Spout-SDK-examples\Examples_2-007-017\SpoutDX\WinSpoutDXreceiver.exe'
