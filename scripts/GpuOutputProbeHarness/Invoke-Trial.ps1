...
$root = 'C:\Users\codea\Documents\timecode-sync-player\.superpowers\worktrees\session-refactor'
Set-Location $root
...
$receiver = 'C:\Users\codea\Downloads\Spout-SDK-examples_2-007-017\Spout-SDK-examples\Examples_2-007-017\SpoutDX\WinSpoutDXreceiver.exe'
