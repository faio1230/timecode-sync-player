...
- 2026-09-17 23:35: **D32 を統合（`adc8200`）**。統合後 main でシナリオ 22/22・LTC ループ 14/14。候補 4 を検証機へ。D33（Single の MediaOut ホールド、`docs/prompts/2026-09-17-D33-…`）を同期担当が実装中。テスト側は S-3 の期待値を [MediaIn, MediaOut] で clamp（除去担当）
- 2026-09-18 00:15: 検証機の候補 3（4469cdd、ミュート起動）: **a 31/36、b 31/36、c 32/36**（候補 2 は 24/24/27）。残り: S-3/S-5（D33）、F-5（ほぼ黒の冒頭参照、テスト側）、C-1 a（黒から始まるジャンプ、テスト側）、G-2 a（製品側の疑い、証跡待ち）、間欠 4 件。詳細は `docs/GSTREAMER-GPU-VALIDATION-PLAN-2026-09-12.md` の候補 3 節
