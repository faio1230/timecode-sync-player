...
素材の実体は現状 `C:\Users\codea\Documents\timecode-sync-player-wt-integrate-20260912\artifacts\media\v1`
にある。
...
```powershell
$app = 'c:\users\codea\documents\timecode-sync-player-wt-pkg-20260915\src\TimecodeSyncPlayer\bin\Debug\net8.0-windows\TimecodeSyncPlayer.exe'
$media = 'c:\users\codea\documents\timecode-sync-player-wt-pkg-20260915\artifacts\media\v11'
